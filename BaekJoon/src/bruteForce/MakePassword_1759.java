...
2 초	128 MB	24818	11315	7959	44.342%
문제
...
public class MakePassword_1759 {
	...
	public static void main(String[] args) throws IOException {
		...
		Password(arr, result, 0, arr.size(), L);
		
		br.close();
	}
	
	private static void Password(List<String> arr, List<String> result, int index, int n, int r) {
		if (r == 0) {
			String answer = "";
